...
export default function SignUpPage3() {
  ...
  return (
    <>
      <div className=" min-h-screen max-h-[200vh] py-5 bg-blue-300 flex justify-center items-center flex-col relative ">
        <div className="flex w-320 h-180  rounded-4xl shadow-lg overflow-hidden bg-white z-0">
          <div className="flex flex-1 flex-col h-fill z-0 justify-center bg-white px-4  sm:px-6 w-180">
                ...
                <div className="space-y-6">
                  ...
                  <div className="relative">
                    <div className="flex items-center border-b border-gray-200 pb-3">
                      ...
                      <input
                        className="flex-1 bg-transparent text-gray-800 placeholder-gray-400 text-base focus:outline-none border-0 p-0"
                  ...
                  <div className="pt-6">
                    <button
                      type="submit"
                      className="w-full bg-blue-400 hover:bg-blue-500 text-white font-medium py-3 px-6 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    ...
                    <div className="text-center mt-4 text-gray-500">
                      Already member?{" "}
                      <Link href="/login" className="text-blue-400 hover:text-blue-500 font-medium">
                        Login
                      </Link>
                    </div>
                  </div>
