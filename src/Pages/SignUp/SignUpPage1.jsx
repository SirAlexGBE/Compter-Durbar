      ...
      <div className="gap-10 h-230 bg-blue-300 flex justify-center items-center flex-col relative max-h-screen">
        ...
        <div className="flex h-[700px] w-[1400px] rounded-4xl shadow-lg overflow-hidden bg-white z-0">
          ...
          <div className="hidden lg:block lg:flex-1 relative  bg-gradient-to-br from-indigo-500 to-blue-400 z-0 overflow-visible ">
            ...
            <div className="absolute top-1/4 left-1/4 bg-white rounded-xl p-4 shadow-lg w-48 z-160">
              {/* Inbox card */}
              <div className="text-orange-500 text-xs font-medium">Inbox</div>
              <div className="text-2xl font-bold">176,18</div>
              <div className="mt-4 h-12 flex items-center">
                <div className="relative w-full h-2 bg-gray-100 rounded-full">
                  <div className="absolute left-0 top-0 h-2 w-2/3 bg-blue-600 rounded-full"></div>
                </div>
                <div className="ml-2 bg-gray-900 text-white text-xs rounded-full h-6 w-6 flex items-center justify-center">
                  45
                </div>
              </div>
              <div className="mt-2">
                ...
                >
                  <path
                    d="M0 15 Q 10 5, 20 20 T 40 10 T 60 25 T 80 5 T 100 15"
                    stroke="#FF8A00"
                    strokeWidth="2"
                    fill="none"
                  />
                  <path
                    d="M0 15 Q 10 25, 20 10 T 40 20 T 60 5 T 80 15 T 100 10"
                    stroke="#3B82F6"
                    strokeWidth="2"
                    fill="none"
                  />
            ...
            <div className="absolute top-1/3 left-100 flex flex-col items-center gap-6 z-160 transform -translate-x-1/2">
              {/* Instagram */}
              <div
                className="bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 p-3 rounded-full shadow-lg cursor-pointer mb-25"
                onClick={() => window.open("https://instagram.com", "_blank")}
              >
                <FaInstagram className="text-white w-6 h-6 animate-pulse" />
              </div>

              {/* TikTok */}
              <div
                className="bg-black p-3 mr-30 rounded-full shadow-lg cursor-pointer"
                onClick={() => window.open("https://www.tiktok.com", "_blank")}
              >
                <FaTiktok className="text-white w-6 h-6 animate-pulse" />
              </div>
            </div>
            <div className="absolute bottom-20 right-1/4 bg-white rounded-xl p-4 shadow-lg w-64 z-160">
              {/* Data security card */}
              <div className="flex justify-between items-center mb-4">
                ...
                <KeyRound size={40} className="text-amber-400 mr-2" />
              </div>
              <div className="font-bold text-lg">Your data, your rules</div>
            ...
            <img
              src="Logo.png"
              alt=""
              className="z-10 absolute  left-[0.5] -translate-x-1/2 w-100 h-100 top-40 object-contain drop-shadow-xl"
            />
