...
const Highlight = () => {
  ...
  return (
    <div className='flex flex-col md:flex-row gap-6  justify-between items-center p-6  bg-white pl-10 mt-5 '>
      ...
      <div className='flex  justify-center items-center w-full md:w-1/2'>
        <div className='bg-[#fff6f6] p-4 rounded-xl   shadow-md max-w-sm w-full '>
