...
const OurMission = () => {
  return (
    <section className="bg-white pb-12 px-6 md:px-20 flex flex-col md:flex-row dark:text-white justify-between gap-8 relative dark:bg-black">
      <div className="md:w-1/2">
        ...
        <button className="inline-flex items-center gap-2 border border-black rounded-md px-4 py-2 hover:bg-black dark:bg-gray-700 dark:hover:text-white dark:text-gray-200 hover:text-white transition">
