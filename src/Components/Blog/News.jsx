...
export default function News() {
  return (
    <div className="w-full p-6  mt-5">
      <div className="flex flex-col md:flex-row bg-white dark:bg-black text-white rounded-xl overflow-hidden pl-5">
        ...
        <div className="w-full md:w-5/6 p-8 mt-5 flex flex-col justify-center   min-h-[200px] ml-4">
          <div className="bg-[#FDF9F9] dark:bg-black text-white py-2 rounded px-3">
            <span className="bg-blue-700 text-white px-6 py-1 rounded-full text-sm mb-5 w-fit">
              News
            </span>

            <h3 className="text-2xl md:text-3xl font-bold mb-4 mt-4 text-gray-800 dark:text-white leading-tight">
