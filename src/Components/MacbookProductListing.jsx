...
//             <div className='w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center cursor-pointer border-2 border-transparent hover:border-blue-500'>
//               <Package className='w-8 h-8 text-gray-400' />
//             </div>
//             <div className='w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center cursor-pointer border-2 border-transparent hover:border-blue-500'>
//               <div className='w-8 h-8 bg-gray-300 rounded'></div>
//             </div>
//             <div className='w-16 h-16 bg-orange-200 rounded-lg flex items-center justify-center cursor-pointer border-2 border-blue-500'>
...
//               <span className='text-sm font-medium'>{PRODUCT_DATA.rating}</span>
//             </div>
//             <span className='text-gray-500'>Sold {PRODUCT_DATA.soldCount}</span>
//           </div>
...
//           <button className='flex items-center gap-1 text-blue-600 hover:text-blue-700 mt-6 transition-colors'>
//             <span>Show More</span>
...
//                 {paymentMethod === "installments" && (
//                   <>
//                     <div className='text-sm mb-3 pl-8 text-gray-500'>
